...
let customerChecked;
let expectationThubmRate, reducing_launch_time_for_localized_products, on_time_delivery_rate, preferred_solution_provider, comprehensive_and_innovative_product_rate, best_business_practices_being_shared_rate, interaction_with_product_specialist, reverie_teams_overall_performance_rate_in_skill_in_delivering_solutions, reverie_teams_overall_performance_rate_in_response_to_queries, reverie_teams_overall_performance_rate_in_domain_expertise, translation_services_experience_rate_in_quality_of_translation, translation_services_experience_rate_in_time_taken_for_translation, translation_services_experience_rate_in_ability_to_understand_domain, reverie_delivery_expectation_rating, insights_related_to_industry, response_to_queries = '';
...
document.getElementById('translation_quality_star5').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_quality_of_translation = 5;
});
document.getElementById('translation_quality_star4').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_quality_of_translation = 4;
});
document.getElementById('translation_quality_star3').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_quality_of_translation = 3;
});
document.getElementById('translation_quality_star2').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_quality_of_translation = 2;
});
document.getElementById('translation_quality_star1').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_quality_of_translation = 1;
});

/* Time taken for translation: */
document.getElementById('time_taken_star5').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_time_taken_for_translation = 5;
});
document.getElementById('time_taken_star4').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_time_taken_for_translation = 4;
});
document.getElementById('time_taken_star3').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_time_taken_for_translation = 3;
});
document.getElementById('time_taken_star2').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_time_taken_for_translation = 2;
});
document.getElementById('time_taken_star1').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_time_taken_for_translation = 1;
});

/* Ability to understand your domain: */
document.getElementById('ability_star5').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_ability_to_understand_domain = 5;
});
document.getElementById('ability_star4').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_ability_to_understand_domain = 4;
});
document.getElementById('ability_star3').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_ability_to_understand_domain = 3;
});
document.getElementById('ability_star2').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_ability_to_understand_domain = 2;
});
document.getElementById('ability_star1').addEventListener('click', (ev) => {
  translation_services_experience_rate_in_ability_to_understand_domain = 1;
});
...
$(document).ready(() => {
  ...
  $('#insights_star5').click(() => {
    insights_related_to_industry = 5;
  })
  $('#insights_star4').click(() => {
    insights_related_to_industry = 4;
  })
  $('#insights_star3').click(() => {
    insights_related_to_industry = 3;
  })
  $('#insights_star2').click(() => {
    insights_related_to_industry = 2;
  })
  $('#insights_star1').click(() => {
    insights_related_to_industry = 1;
  })

  /* Responsiveness to your queries: */
  $('#queries_star5').click(() => {
    response_to_queries = 5;
  })
  $('#queries_star4').click(() => {
    response_to_queries = 4;
  })
  $('#queries_star3').click(() => {
    response_to_queries = 3;
  })
  $('#queries_star2').click(() => {
    response_to_queries = 2;
  })
  $('#queries_star1').click(() => {
    response_to_queries = 1;
  })
...
const generateFeedback = async (ev) => {
  try{
    ev.preventDefault();
  ...
  if (currentUser === 'customer') {
    if (expectationThubmRate === 5 || expectationThubmRate === 4) {
      feedback.reverie_delivery_expectation_rating = expectationThubmRate;
      feedback.reverie_delivery_expectation_comment = document.getElementById('excellent-text-area').value;
    }
    if (expectationThubmRate === 3) {
      feedback.reverie_delivery_expectation_rating = expectationThubmRate;
      feedback.reverie_delivery_expectation_comment = document.getElementById('good-text-area').value;
    }
    if (expectationThubmRate === 2 || expectationThubmRate === 1) {
      feedback.reverie_delivery_expectation_rating = expectationThubmRate;
      feedback.reverie_delivery_expectation_comment = document.getElementById('bad-text-area').value;
    }
    ...
    feedback.reverie_teams_overall_performance_rate_in_skill_in_delivering_solutions = reverie_teams_overall_performance_rate_in_skill_in_delivering_solutions;
    feedback.reverie_teams_overall_performance_rate_in_response_to_queries = reverie_teams_overall_performance_rate_in_response_to_queries;
    feedback.reverie_teams_overall_performance_rate_in_domain_expertise = reverie_teams_overall_performance_rate_in_domain_expertise;
    ...
    feedback.translation_services_experience_rate_in_quality_of_translation = translation_services_experience_rate_in_quality_of_translation;
    feedback.translation_services_experience_rate_in_time_taken_for_translation = translation_services_experience_rate_in_time_taken_for_translation;
    feedback.translation_services_experience_rate_in_ability_to_understand_domain = translation_services_experience_rate_in_ability_to_understand_domain;
  ...
  if (currentUser === 'partner') {
    if (ability_to_deliver_expectation === 4 || ability_to_deliver_expectation === 5) {
      feedback.partner_delivery_expectation_rating = ability_to_deliver_expectation;
      feedback.partner_delivery_expectation_comment = document.getElementById('text_area45').value;
    }
    if (ability_to_deliver_expectation === 3) {
      feedback.partner_delivery_expectation_rating = ability_to_deliver_expectation;
      feedback.partner_delivery_expectation_comment = document.getElementById('text_area3').value;
    }
    if (ability_to_deliver_expectation === 2 || ability_to_deliver_expectation === 1) {
      feedback.partner_delivery_expectation_rating = ability_to_deliver_expectation;
      feedback.partner_delivery_expectation_comment = document.getElementById('text_area12').value;
    }
    if (training_support_to_clients === 4 || training_support_to_clients === 5) {
      feedback.reverie_training_support_to_clients_rating = training_support_to_clients;
      feedback.reverie_training_support_to_clients_comment = document.getElementById('help_text_area45').value;
    }
    if (training_support_to_clients === 3) {
      feedback.reverie_training_support_to_clients_rating = training_support_to_clients;
      feedback.reverie_training_support_to_clients_comment = document.getElementById('help_text_area3').value;
    }
    if (training_support_to_clients === 2 || training_support_to_clients === 1) {
      feedback.reverie_training_support_to_clients_rating = training_support_to_clients;
      feedback.reverie_training_support_to_clients_comment = document.getElementById('help_text_area12').value;
    }
    ...
    feedback.reverie_team_rate_based_on_insights_related_to_industry = insights_related_to_industry;
    feedback.reverie_team_rate_based_on_response_to_queries = response_to_queries;
    feedback.reverie_team_rate_based_on_domail_expertise = domail_expertise;
  ...
  let feedbackData = await senddata(feedbackValues);
  ...
  timely_response_to_queries = '';
  reverie_delivery_expectation_rating = '';
  reducing_launch_time_for_localized_products = '';
  on_time_delivery_rate = '',
    reverie_teams_overall_performance_rate_in_skill_in_delivering_solutions = '';
  reverie_teams_overall_performance_rate_in_response_to_queries = '';
  reverie_teams_overall_performance_rate_in_domain_expertise = '';
  preferred_solution_provider = '';
  comprehensive_and_innovative_product_rate = '';
  best_business_practices_being_shared_rate = '';
  translation_services_experience_rate_in_quality_of_translation = '';
  translation_services_experience_rate_in_time_taken_for_translation = '';
  translation_services_experience_rate_in_ability_to_understand_domain = '';
  interaction_with_product_specialist = '';
  partner_delivery_expectation_rating = '';
  reverie_training_support_to_clients_rating = '';
  time_reduced_in_product_launch = '';
  rate_of_product_effictiveness = '';
  client_suppurt_cycle_rate = '';
  relevant_collaterals_and_effective_demos = '';
  engagement_with_teams_rate = '';
  reverie_team_rate_based_on_insights_related_to_industry = '';
  reverie_team_rate_based_on_response_to_queries = '';
  reverie_team_rate_based_on_domail_expertise = '';
  reverie_portfolio_help_rate = '';
  recommenr_reverie_for_localization_rate = '';
  reverie_offer_rate = '';
  feedbackValues = [];

  return toastr.success(feedbackData.msg);
  }else{
    toastr.error(feedbackData.msg);
  }  
  }catch(error){
    console.log(error);
    toastr.error('Error occured while submitting feedback', error.message)
  }
}
